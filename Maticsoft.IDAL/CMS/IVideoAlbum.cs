...
namespace Maticsoft.IDAL.CMS
{
	...
	public interface IVideoAlbum
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.CMS.VideoAlbum model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.CMS.VideoAlbum model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.CMS.VideoAlbum GetModel(int AlbumID);
		/// <summary>
		/// 获得数据列表
		/// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        Maticsoft.Model.CMS.VideoAlbum GetModelEx(int AlbumID);
        #region 批量处理
        /// <summary>
        /// 批量处理
        /// </summary>
