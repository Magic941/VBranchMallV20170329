...
namespace Maticsoft.IDAL.SNS
{
	...
	public interface ITags
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.SNS.Tags model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.SNS.Tags model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.SNS.Tags GetModel(int TagID);
		Maticsoft.Model.SNS.Tags DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
