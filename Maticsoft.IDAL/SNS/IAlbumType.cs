...
namespace Maticsoft.IDAL.SNS
{
	...
	public interface IAlbumType
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.SNS.AlbumType model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.SNS.AlbumType model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		bool Delete(int ID);
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.SNS.AlbumType GetModel(int ID);
		Maticsoft.Model.SNS.AlbumType DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
