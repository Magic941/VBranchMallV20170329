...
namespace Maticsoft.IDAL.Pay
{
	...
	public interface IBalanceDetails
	{
		...
		/// 增加一条数据
		/// </summary>
		long Add(Maticsoft.Model.Pay.BalanceDetails model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.Pay.BalanceDetails model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.Pay.BalanceDetails GetModel(long JournalNumber);
		Maticsoft.Model.Pay.BalanceDetails DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
