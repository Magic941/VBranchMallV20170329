...
namespace Maticsoft.IDAL.Shop.Coupon
{
	...
	public interface ICouponClass
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.Shop.Coupon.CouponClass model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.Shop.Coupon.CouponClass model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.Shop.Coupon.CouponClass GetModel(int ClassId);
		Maticsoft.Model.Shop.Coupon.CouponClass DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
