...
namespace Maticsoft.IDAL.Shop.Products
{
    ...
    public interface IHotKeyword
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(Maticsoft.Model.Shop.Products.HotKeyword model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(Maticsoft.Model.Shop.Products.HotKeyword model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        bool Delete(int Id);
        ...
        /// 得到一个对象实体
        /// </summary>
        Maticsoft.Model.Shop.Products.HotKeyword GetModel(int Id);
        /// <summary>
        /// 获得数据列表
        /// </summary>
