...
namespace Maticsoft.IDAL.Shop.Sales
{
	...
	public interface ISalesRuleProduct
	{
		...
		/// 增加一条数据
		/// </summary>
		bool Add(Maticsoft.Model.Shop.Sales.SalesRuleProduct model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.Shop.Sales.SalesRuleProduct model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.Shop.Sales.SalesRuleProduct GetModel(int RuleId,long ProductId);
		Maticsoft.Model.Shop.Sales.SalesRuleProduct DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
