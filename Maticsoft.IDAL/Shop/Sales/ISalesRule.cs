...
namespace Maticsoft.IDAL.Shop.Sales
{
	...
	public interface ISalesRule
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.Shop.Sales.SalesRule model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.Shop.Sales.SalesRule model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.Model.Shop.Sales.SalesRule GetModel(int RuleId);
		Maticsoft.Model.Shop.Sales.SalesRule DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
