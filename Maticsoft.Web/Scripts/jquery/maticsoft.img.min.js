...
*/function maticsoftImgGet404URL(e, t) {
    var n = "/Content/themes/base/images/404/";
    return e <= 80 || t <= 80 ? n += "80.jpg" : e <= 142 || t <= 142 ? n += "142.jpg" : e <= 224 || t <= 224 ? n += "224.jpg" : e <= 230 || t <= 230 ? n += "230.jpg" : e <= 260 || t <= 260 ? n += "260.jpg" : n += "142.jpg", n
} function resizeImg(e, t, n, r) { $.lazyScaleLoad(e, t, n, r) } function zoomImg(e, t, n) { return $.scaleImg(e, t, n) } (function (e) {
    e.lazyScaleLoad = function (t, n, r, i) {
        if (!t) return; var s = e(t).find("img");
        for (var o = 0; o < s.length; o++) (function (t) {
            if (e(t).attr("src")) return;
            if (e(t).attr("loaded")) return; e.scaleLoadInit(t, n, r), e(t).lazyload({
                effect: "fadeIn", skip_invisible: !1, load: function (t, s)
                {
                    var o = this; imgReady(e(o).attr("data-original"), function () { e.scaleImg(this, n, r, o), e(o).attr("loaded") != "ERROR" && e(o).attr("loaded", "NO") },
                      function () { i && i.call(o), e(o).attr("loaded") != "ERROR" && e(o).attr("loaded", "OK") }, function () { var t = maticsoftImgGet404URL(n, r); imgReady(t, null, function () { e(o).attr("src", t), e.scaleImg(this, n, r, o), i && i.call(o), e(o).attr("loaded", "ERROR") }) })
                }
            })
        })(s[o])
    }, e.lazyFixedLoadImg = function (t, n, r, i) {
        if (!t) return; var s = e(t).find("img"); for (var o = 0; o < s.length; o++) (function (t) {
            if (e(t).attr("src")) return;
            if (e(t).attr("loaded")) return; e.scaleLoadInit(t, n, r), e(t).lazyload({
                effect: "fadeIn", skip_invisible: !1, load: function (t, s) {
                    var o = this; imgReady(e(o).attr("data-original"), function ()
                    { this.width = n, this.height = r, o.width = n, o.height = r, e(o).attr("loaded") != "ERROR" && e(o).attr("loaded", "NO") },
                    function () { i && i.call(o), e(o).attr("loaded") != "ERROR" && e(o).attr("loaded", "OK") }, function () {
                        var t = maticsoftImgGet404URL(n, r);
                        imgReady(t, null, function () { e(o).attr("src", t), this.width = n, this.height = r, o.width = n, o.height = r, i && i.call(o), e(o).attr("loaded", "ERROR") })
                    })
                }
            })
        })(s[o])
    }, e.scaleLoadInit = function (t, n, r) {
        e(t).attr("loaded", "loading"), e(t).show();
        var i = e(t).attr("ref") ? e(t).attr("ref") : e(t).attr("src"); i ? e(t).attr("data-original", i) : (e(t).attr("data-original", maticsoftImgGet404URL(n, r)), e(t).attr("loaded", "ERROR")),
        e(t).removeAttr("ref"), t.removeAttribute("height"), t.removeAttribute("width"), t.style.height = t.style.width = "",
        e(t).attr("src", "/Content/themes/base/images/transparent.gif"), e(t).attr("width", n + "px"), e(t).attr("height", r > 300 ? "300px" : r + "px")
    }, e.scaleLoad = function (t, n, r, i) {
        if (!t) return; var s = e(t).find("img"); for (var o = 0; o < s.length; o++) (function (t) {
            if (e(t).attr("loaded")) return;
            e.scaleLoadInit(t, n, r); var s = e(t).attr("data-original"); imgReady(s, function () { e.scaleImg(this, n, r, t), e(t).attr("loaded") != "ERROR" && e(t).attr("loaded", "NO") }, function () { e(t).attr("src", s), i && i.call(t), e(t).attr("loaded") != "ERROR" && e(t).attr("loaded", "OK") }, function () { var s = maticsoftImgGet404URL(n, r); imgReady(s, null, function () { e(t).attr("src", s), e.scaleImg(this, n, r, t), i && i.call(t), e(t).attr("loaded", "ERROR") }) })
        })(s[o])
    }, e.scaleFixedLoad = function (t, n, r, i) { if (!t) return; var s = e(t).find("img"); for (var o = 0; o < s.length; o++) (function (t) { if (e(t).attr("loaded")) return; e.scaleLoadInit(t, n, r); var s = e(t).attr("data-original"); imgReady(s, function () { this.width = n, this.height = r, e(t).attr("loaded") != "ERROR" && e(t).attr("loaded", "NO") }, function () { e(t).attr("src", s), i && i.call(t), e(t).attr("loaded") != "ERROR" && e(t).attr("loaded", "OK") }, function () { var s = maticsoftImgGet404URL(n, r); imgReady(s, null, function () { e(t).attr("src", s), this.width = n, this.height = r, i && i.call(t), e(t).attr("loaded", "ERROR") }) }) })(s[o]) }, e.scaleImg = function (e, t, n, r) { var i = 0; n && t && (i = t / n); var s = e.height, o = e.width, u = o / s, a = n, f = t, l = i; l || (a ? l = u + 1 : l = u - 1); if (a && s > a || f && o > f) u > l ? a = ~~(s / o * f) : f = ~~(o / s * a), e.height = a, e.width = f; return r && (r.width = e.width, r.height = e.height), e }
