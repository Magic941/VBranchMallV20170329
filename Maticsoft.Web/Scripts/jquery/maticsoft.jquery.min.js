...
*/function modFoat(e) { var t = parseInt(e) + 1; return t - e < 1 ? t : e } function getIEVersion() {
    var e = -1; if (navigator.appName == "Microsoft Internet Explorer")
    { var t = navigator.userAgent, n = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})"); n.exec(t) != null && (e = parseFloat(RegExp.$1)) } return e
} function loclkey(e) {
    var t; window.event ? t = e.keyCode : e.which && (t = e.which);
    if (t == 17) return !1; window.event.altKey && (window.event.keyCode == 37 || window.event.keyCode == 39) && (event.returnValue = !1), event.ctrlKey && event.keyCode == 82 && (event.keyCode = 0, event.returnValue = !1), event.keyCode == 122 && (event.keyCode = 0, event.returnValue = !1), event.ctrlKey && event.keyCode == 78 && (event.returnValue = !1), event.shiftKey && event.keyCode == 121 && (event.returnValue = !1), window.event.srcElement.tagName == "A" && window.event.shiftKey && (window.event.returnValue = !1); if (window.event.altKey && window.event.keyCode == 115) return window.showModelessDialog("about:blank", "", "dialogWidth:1px;dialogheight:1px"), !1
} function CheckDate(INDate) {
    if (INDate == "") return !0; subYY = INDate.substr(0, 4); if (isNaN(subYY) || subYY <= 0) return !0; if (INDate.indexOf("-", 0) != -1) separate = "-";
    else { if (INDate.indexOf("/", 0) == -1) return !0; separate = "/" } area = INDate.indexOf(separate, 0), subMM = INDate.substr(area + 1, INDate.indexOf(separate, area + 1) - (area + 1)); if (isNaN(subMM) || subMM <= 0) return !0; subMM.length < 2 && (subMM = "0" + subMM), area = INDate.lastIndexOf(separate), subDD = INDate.substr(area + 1, INDate.length - area - 1); if (isNaN(subDD) || subDD <= 0) return !0; eval(subDD) < 10 && (subDD = "0" + eval(subDD)), NewDate = subYY + "-" + subMM + "-" + subDD; if (NewDate.length != 10) return !0; if (NewDate.substr(4, 1) != "-") return !0; if (NewDate.substr(7, 1) != "-") return !0; var MM = NewDate.substr(5, 2), DD = NewDate.substr(8, 2); if (subYY % 4 == 0 && subYY % 100 != 0 || subYY % 400 == 0) { if (parseInt(MM) == 2 && DD > 29) return !0 } else if (parseInt(MM) == 2 && DD > 28) return !0; var mm = new Array(1, 3, 5, 7, 8, 10, 12), flag = !1; for (i = 0; i < mm.length; i++) parseInt(MM, 10) == mm[i] && (flag = !0); if (flag == 1) { if (parseInt(DD) > 31) return !0 } else if (parseInt(DD) > 30) return !0; return parseInt(MM) > 12 ? !0 : !1
} function guidGenerator() {
    var e = function () { return ((1 + Math.random()) * 65536 | 0).toString(16).substring(1) };
    return e() + e() + "-" + e() + "-" + e() + "-" + e() + "-" + e() + e() + e()
} $.ajaxSetup({ cache: !1 }), String.prototype.format = function () {
    var e = arguments;
    return this.replace(/{(\d+)}/g, function (t, n) { return typeof e[n] != "undefined" ? e[n] : t })
}, String.prototype.sub = function (e, t) {
    var n = this.slice(0, e), r = n.replace(/[^x00-xff]/g, "**").length; if (r <= e) return n; var i = t ? "…" : ""; r -= n.length;
    switch (r) { case 0: return n; case e: return this.slice(0, e >> 1) + i; default: var s = e - r, o = this.slice(s, e), u = o.replace(/[x00-xff]/g, "").length; return (u ? this.slice(0, s) + o.sub(u) : this.slice(0, s)) + i }
}, typeof String.prototype.startsWith != "function" && (String.prototype.startsWith = function (e) { return this.slice(0, e.length) == e }),
typeof String.prototype.endsWith != "function" && (String.prototype.endsWith = function (e) { return this.slice(-e.length) == e }),
function (e) {
