...
//                                                ajax.request('/ueditor/net/imageDel.ashx', { 
//                                                    action: "del",
//                                                    method:"post",
//                                                    fileName: src,
//                                                    onsuccess: function (xhr) {
...
//                                                this.title = "点击切换选择状态  双击删除图片\n原图尺寸:" + w + "X" + h;//+ "\n   图片名:" + src.substr(src.lastIndexOf("/") + 1);
//                                            };
//                                            img.setAttribute(i < 35 ? "src" : "lazy_src", editor.options.imageManagerPath + ci);
