...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Accession.aspx.cs" Inherits="Maticsoft.Web.Admin.JLT.UserAttendance.Accession" %>
            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal4" runat="server" Text="入职公司" />：
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:Button ID="btnSave" runat="server" Text="入职"
