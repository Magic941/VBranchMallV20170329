<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="PersonalList.aspx.cs" Inherits="Maticsoft.Web.Admin.JLT.UserAttendance.PersonalList" %>
        ...
        <div class="newslist">
            <div class="newsicon">
                <ul>
                    ...
                    <li id="a_return" runat="server" style="background: url(/admin/images/reload.png) no-repeat"><a href="../../Members/MembershipManage/List.aspx">
                        <asp:Literal ID="Literal7" runat="server" Text="返回" /></a><b>|</b></li>
                </ul>
            </div>
        </div>
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True" ShowToolBar="false" AutoGenerateColumns="False" OnBind="BindData" OnPageIndexChanging="gridView_PageIndexChanging" OnRowDataBound="gridView_RowDataBound" UnExportedColumnNames="Modify" Width="100%" PageSize="100" DataKeyNames="ID" ShowExportExcel="True" ShowExportWord="False" ExcelFileName="FileName1" CellPadding="3" BorderWidth="1px" ShowCheckAll="true">
            <Columns>
                ...
                <asp:TemplateField HeaderText="详细" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <a href="Show.aspx?id=<%#Eval("ID") %>&type=<%=TypeID %>">详细</a>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="批复" ItemStyle-HorizontalAlign="Center" Visible="False">
                    <ItemTemplate>
                        <a href="Approval.aspx?id=<%#Eval("ID") %>&type=<%=TypeID %>">批复</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
    ...
    <table border="0" cellpadding="0" cellspacing="1" style="width: 100%; height: 100%;">
        ...
        <tr id="appControl" runat="server">
            ...
            <td>
                ...
                <asp:Literal ID="Literal5" runat="server" Text="批复状态："></asp:Literal>
                <asp:DropDownList ID="drop_RevStatus" runat="server">
                    <asp:ListItem Value="-1" Text="--请选择--" Selected="True"></asp:ListItem>
