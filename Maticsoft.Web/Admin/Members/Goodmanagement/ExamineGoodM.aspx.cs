...
{
    public partial class ExamineGoodM : PageBaseAdmin
    {
        public string strid = "";
        ...
        private void ShowInfo(int ID)
        {
            ...
            if (manage != null && model != null)
            {
                ...
                {
                    this.lblUserAppType.Text = "个人微店申请";
                }
            ...
            if (model != null)
            {
                ...
                string strAddress = RegionBll.GetRegionNameByRID(Common.Globals.SafeInt(model.RegionId, 0))+""+model.Address.ToString();
