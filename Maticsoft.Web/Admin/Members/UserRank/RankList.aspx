...
<%@ Page Title="用户等级" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="RankList.aspx.cs" Inherits="Maticsoft.Web.Admin.Members.UserRank.RankList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        ...
        <div class="newslist">
            <div class="newsicon">
                <ul>
                    <li style="background: url(/images/icon8.gif) no-repeat 5px 3px" id="liAdd" runat="server"><a href="AddRank.aspx">  添加</a> <b>|</b> </li>
                </ul>
            </div>
        </div>
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" HeaderText="等级名称"    ItemStyle-HorizontalAlign="Center" />
                <asp:TemplateField HeaderText="等级图标" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <span class='W_level_ico<%#Eval("Name") %>' ><span node-type="level" ></span> </span>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="PointMin" HeaderText="积分下限"   ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="PointMax" HeaderText="积分上限"    ItemStyle-HorizontalAlign="Center" />
