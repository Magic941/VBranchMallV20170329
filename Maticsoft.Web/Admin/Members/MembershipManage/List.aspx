        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                ...
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    ...
                    <asp:TextBox ID="txtEndTime" runat="server" CssClass="PostDate" ReadOnly="True"> </asp:TextBox>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                    <ItemTemplate>
                        ...
                        <a href='show.aspx?id=<%#Eval("UserID") %>'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href='UserLog.aspx?user=<%#Eval("UserName") %>'>
                            日志</a>
                    </ItemTemplate>
                </asp:TemplateField>
