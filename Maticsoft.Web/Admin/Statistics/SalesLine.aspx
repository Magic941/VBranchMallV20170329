<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="SalesLine.aspx.cs" Inherits="Maticsoft.Web.Admin.Statistics.SalesLine" Title="销量/业绩走势图" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="litTitle" runat="server" Text="{0}走势图" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="litDec" runat="server" Text="您可以查看{0}走势图信息" />
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            ...
                            <td style="float: left;height: 38px;line-height: 38px;">
                                &emsp;&emsp;<asp:Button ID="btnReStatistic" runat="server" Text="统计" class="adminsubmit" OnClick="btnReStatistic_OnClick" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
