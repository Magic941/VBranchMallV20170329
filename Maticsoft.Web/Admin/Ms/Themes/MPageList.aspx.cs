...
namespace Maticsoft.Web.Admin.Ms.Themes
{
    public partial class MPageList : PageBaseAdmin
    {
        ...
        {
            //获取该主区域 下的所有模板
            List<Maticsoft.Model.Ms.Theme> themeList = Maticsoft.Web.Components.FileHelper.GetThemes("MPage");
            //获取当前主模板
        ...
        protected void DataListPhoto_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "start")
            {
                if (e.CommandArgument != null)
                {
                    ...
                    //写
                    Maticsoft.BLL.SysManage.ConfigSystem.Modify("MPage_Theme", name, "微官网模板的名称");
