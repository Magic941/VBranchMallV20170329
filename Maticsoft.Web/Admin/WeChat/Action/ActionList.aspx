<%@ Page Title="微信系统指令管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="ActionList.aspx.cs" Inherits="Maticsoft.Web.Admin.WeChat.Action.ActionList" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="微信系统指令是程序级功能行为，只有开发人员可以添加和维护该数据。" />
                    </td>
                </tr>
            </table>
        </div>
