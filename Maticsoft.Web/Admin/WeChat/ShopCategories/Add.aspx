<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.Admin.WeChat.ShopCategories.Add"
     %>
...
<body>
    ...
    <div class="newslistabout"  style="width:100%; margin:0 auto;">
        <div class="newslist_title">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:CMSPhoto,ptAddGoodTypeClass %>"/>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:CMSPhoto,lblGoodTypeClass %>"/>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25" width="*" align="left">
                                <uc1:GoodTypeDropList ID="ddlgoodtype" runat="server" IsNull="True"  />
                            </td>
                        </tr>
                        <tr>
                            <td height="25" width="30%" align="right">
