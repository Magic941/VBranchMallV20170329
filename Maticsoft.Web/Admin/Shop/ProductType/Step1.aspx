<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step1.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ProductType.Step1" %>
    ...
    <script type="text/javascript">
        ...
        var grid, manager, gridR, managerR;        $(function () {
            ...
            gridR = managerR = $("#result").ligerGrid({
                ...
                ], parms: { Action: "GetProductTypeList" },
            ...
            $("#btnNext").click(function () {
                ...
                $.post("/Ajax_Handle/ProductBrands.ashx", { Value1: $("[id$=txtTypeName]").val(), Value2: $("[id$=txtRemark]").val(), Value3: brandList, Action: "AddProductType" }, function (data) {
                    if (data.toString().trim() != "") {
                        $(this).attr("disabled", "disabled");
                        $("#btnCancel").attr("disabled", "disabled");
                        location.href = data.toString().trim();
                    }
                    else {
            ...
            <div class="newslistabout">
                <div class="newslist_title">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" class="newstitlebody">您可以<asp:Literal ID="Literal3" runat="server" Text="商品类型是一系列属性的组合，可以用来向客户展示某些商品具有的特有的属性。" />
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtTypeName" CssClass="l-text" runat="server" Width="372px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtRemark" CssClass="l-text" runat="server" Width="372px" Height="25px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="td_class"></td>
                                    <td height="25">
                                        <input id="btnNext" class="l-button" type="button" value="下一步" />
