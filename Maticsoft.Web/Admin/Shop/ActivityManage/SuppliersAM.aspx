<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true" CodeBehind="SuppliersAM.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ActivityManage.SuppliersAM" %>
    ...
    <div  style="background: white;width: 100%" id="relatedProc">
        ...
        <div class="Goodsgifts">
            ...
            <div class="left" style="width:100%; margin:0 auto;overflow-y:hidden ">
                <div style="float:left"><h1><asp:Literal ID="litDesc" runat="server" Text="设置活动商铺"></asp:Literal></h1></div>
                <div id="divLeftbuttom" style="display:block">
                    <asp:panel id="Panel1" runat="server" defaultbutton="btnSearch">
                        ...
                        <table style="clear:both" id="tbSelect">
                            <tr>
                                 <td>
                                   <asp:Literal ID="Literal5" runat="server" Text="商铺" />：
                                   <span>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:BoundField DataField='<%# GetSupplier(Eval("SupplierId")) %>' HeaderText="商家名称"/>--%>
                                            <%--<asp:BoundField DataField="AMId" HeaderText="活动ID" />--%>
