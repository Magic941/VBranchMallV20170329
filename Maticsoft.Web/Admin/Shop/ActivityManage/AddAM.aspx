<%@ Page Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master"  AutoEventWireup="true" CodeBehind="AddAM.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ActivityManage.AddAM" %>


<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAM.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ActivityManage.AddAM" %>--%>
                            ...
                            <tr>
                                ...
                                <td height="25">
                                    <asp:RadioButtonList ID="AMType" runat="server" RepeatDirection="Horizontal"
                                        align="left">
                                        <asp:ListItem Value="1" Text="折扣" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="减价"></asp:ListItem>
                                        <%--<asp:ListItem Value="2" Text="固定价"></asp:ListItem>--%>
                                    </asp:RadioButtonList>
                                    <span style="font-size:12px; color:#808080">(可以根据选择单位和方式更换规则内容)</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
    ...
    <table id="txtTemplate" style="display: none">
        <tr>
            <td style="width: auto" class="RuleItems">
                ...
                <span class="AMDRuleUnit">&nbsp;元</span>
                <span class="ItemType"></span>
                <input type="text" class="AMDRateValue" style="height:20px"><span class="ItemUnit">% (例如: 8.5折→填85)</span>&nbsp;<span class="hy d_default"></span>
            </td>
            <td style="width: 55px;">
