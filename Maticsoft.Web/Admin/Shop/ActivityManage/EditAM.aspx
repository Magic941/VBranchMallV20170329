...
<%@ Page Language="C#" Title="修改活动规则" MasterPageFile="~/Admin/BasicNoFoot.Master"
    AutoEventWireup="true" CodeBehind="EditAM.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ActivityManage.EditAM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            var itemTypevalue = $("#ctl00_ContentPlaceHolder1_AMType").find("input[checked='checked']").val();
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                            <tr>
                                <td colspan="2" class="newstitle" bgcolor="#FFFFFF">
                                    <span style="font-size: 16px; padding-left: 20px">活动规则设置</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>  
                                ...
                                <td height="25">
                                    <asp:RadioButtonList ID="AMType" runat="server" RepeatDirection="Horizontal"
                                        align="left">
                                        <asp:ListItem Value="1" Text="打折" Selected="True"></asp:ListItem>
    ...
    <table id="txtTemplate" style="display: none">
        <tr>
            <td style="width: auto" class="RuleItems">
                ...
                <input type="text" class="AMDRateValue" value="{1}"><span class="ItemUnit">% (例如: 8.5折→85)</span>&nbsp;<span class="hy d_default"></span>
            </td>
            <td style="width: 55px;">
