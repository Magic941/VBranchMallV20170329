<%@ Page Title="活动管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="AMList.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.ActivityManage.AMList" %>
            ...
            <div class="newsicon">
                <ul>
                    <li id="liAdd" runat="server" style="background: url(/images/icon8.gif) no-repeat 5px 3px">
                        <a class="iframe" href="AddAM.aspx">添加</a> <b>|</b> </li>
            ...
            <Columns>
                ...
                <asp:TemplateField ControlStyle-Width="50" HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        ...
                        <a class="SetProduct" <%#int.Parse(Eval("AMApplyStyles").ToString())!=0 ?"disabled='FALSE'":"" %> href='SetProductAM.aspx?id=<%# Eval("AMId") %>'>设置活动商家 </a>
                        &nbsp;&nbsp; <span id="lbtnModify" runat="server"><a class="iframe" href='EditAM.aspx?id=<%# Eval("AMId") %>'>
                            修改</a>&nbsp;</span>
