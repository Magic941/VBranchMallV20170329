<%@ Page Title="确认收货" Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Basic.Master" CodeBehind="OrderComplete.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Order.OrderComplete" %>
            ...
            <table style="width: 100%; float: left; border: 1px solid #808080" cellpadding="2"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang"
                            ...
                            <tr>
                                <td class="td_class" style="color:red">
                                    <asp:Literal ID="Literal12" runat="server" Text="实际退款金额" />：
                                </td>
                                <td height="25" class="td_content">
                ...
                <tr id="Tr1" runat="server">
                    <td style="vertical-align: top;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                            <tr>
                                    <td colspan="2" class="newstitle" bgcolor="#FFFFFF">
                                        <span style="font-size: 16px; padding-left: 20px">拒绝退货(请填写拒绝理由)</span>
                                    </td>
                                </tr>
                            <tr>
                                <td class="td_class" style="background-color: #E2E8EB">
                ...
                <tr>
                    <td height="25" colspan="2" align="center">
                        <asp:Button ID="btnPass" runat="server" Text="确认收货"
                            OnClick="btnPass_OnClick" class="adminsubmit_short"></asp:Button>&nbsp;<asp:Button ID="btnRefusal" runat="server" Text="拒绝收货"
