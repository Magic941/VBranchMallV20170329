...
{
    public partial class WeiXinGroupBuyList : PageBaseAdmin
    {
        ...
        public void BindData()
        {
            ...
            int GoodsTypeID = Common.Globals.SafeInt(drpProductCategory.SelectedValue,-1);
            ...
            if (GoodsTypeID != -1)
            {
                whereStr.AppendFormat(" GoodsTypeID ={0} ", GoodsTypeID);
            }
            //开始时间
            ...
            if (!string.IsNullOrWhiteSpace(productName))
            {
                ...
                whereStr.AppendFormat(" a.ProductName Like '%{0}%'", productName.Trim());
            }
            if (!string.IsNullOrWhiteSpace(productid))
            {
                ...
                whereStr.AppendFormat(" ProductCode Like '%{0}%'", productid.Trim());
            }

            DataSet ds = WeiXinbuyBll.GetList(-1, whereStr.ToString(), " Sequence desc  ");
        ...
        /// <param name="target"></param>
        /// <returns></returns>
        public string GetIsIndex(object target)
        {
            string str = string.Empty;
            if (!StringPlus.IsNullOrEmpty(target))
            {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (idlist.Trim().Length == 0)
                return;
            if (WeiXinbuyBll.DeleteList(idlist))
            {
        ...
        protected void btnOn_Click(object sender, EventArgs e)
        {
            ...
            if (idlist.Trim().Length == 0)
                return;
            if (WeiXinbuyBll.UpdateStatus(idlist, 1))
            {
                MessageBox.ShowSuccessTip(this, "操作成功！");
            }
            else
        ...
        protected void btnOff_Click(object sender, EventArgs e)
        {
            ...
            if (idlist.Trim().Length == 0)
                return;
            if (WeiXinbuyBll.UpdateStatus(idlist, 0))
            {
                MessageBox.ShowSuccessTip(this, "操作成功！");
            }
            else
        ...
        {
            Maticsoft.BLL.Shop.Products.GoodsType bll = new BLL.Shop.Products.GoodsType();
            ...
            if (ds!=null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    this.drpProductCategory.DataTextField = "GoodTypeName";
                    this.drpProductCategory.DataValueField = "GoodTypeID";
                    this.drpProductCategory.DataBind();
                }
            }
            this.drpProductCategory.Items.Insert(0, new ListItem("请选择类型","-1"));
        }

        #endregion

        /// <summary>
        /// 更新选中的数据UpdateTime 并进行倒序排序 排列靠前
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnEditUpdatetime_Click(object sender, EventArgs e)
        {
           string idlist = GetSelIDlist();
            if(idlist.Trim().Length==0)return ;
            Array list = idlist.Split(',');
            string CurrentTime = DateTime.Now.ToString();
            Maticsoft.BLL.Shop.Products.ProductInfo Pinfo = new ProductInfo();
            Pinfo.UpdateListDate2(idlist, CurrentTime);
