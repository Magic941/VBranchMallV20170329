<%@ Page Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="WeiXinUpdateGroupBuy.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.PromoteSales.WeiXinUpdateGroupBuy" %>
                    ...
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25">
                                ...
                                <asp:RangeValidator ID="RangeValidator1" Display="Dynamic" ForeColor="Red" Type="Integer" ControlToValidate="txtMaxCount"
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:TextBox ID="txtPromotionLimitQu" runat="server" Width="100px" MaxLength="30"></asp:TextBox>
                                <asp:RangeValidator ID="RangeValidator5" Display="Dynamic" ForeColor="Red" Type="Integer" ControlToValidate="txtPromotionLimitQu"
                                    MinimumValue="0" MaximumValue="1000000" runat="server" ErrorMessage="请填写数字"></asp:RangeValidator>
                            
                                &nbsp;&nbsp;<asp:Literal ID="Literal18" runat="server" Text="最低起订量" />：
                            
                                <asp:TextBox runat="server" ID="txtLeastbuyNum" Width="100"  MaxLength="30"></asp:TextBox>
                                <asp:RangeValidator ID="RangeValidator3" Display="Dynamic" ForeColor="Red" Type="Integer" ControlToValidate="txtLeastbuyNum"
                                    MinimumValue="0" MaximumValue="1000000" runat="server" ErrorMessage="请填写数字"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="25">
                                ...
                                <asp:RangeValidator ID="RangeValidator2" Display="Dynamic" ForeColor="Red" Type="Integer" ControlToValidate="txtGroupCount"
                                    MinimumValue="0" MaximumValue="1000000" runat="server" ErrorMessage="请填写数字"></asp:RangeValidator>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="Tr1">
                            <td class="td_class">
                                <asp:Literal ID="Literal13" runat="server" Text="微信商品分类" />：
                            </td>
                            <td height="25">
                                <asp:DropDownList ID="dllGoodsTypeID0" runat="server" AutoPostBack="true" Width="160px" OnSelectedIndexChanged="dllGoodsTypeID0_SelectedIndexChanged">
                                </asp:DropDownList>
                                ...
                                <asp:DropDownList ID="dllGoodsTypeID3" runat="server" Width="160px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                         <tr>
