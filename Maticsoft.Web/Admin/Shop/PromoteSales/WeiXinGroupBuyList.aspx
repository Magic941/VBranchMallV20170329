<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="WeiXinGroupBuyList.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.PromoteSales.WeiXinGroupBuyList" %>
    ...
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="微信营销活动商品管理" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">您可以对微信营销活动商品进行添加，编辑，删除，上架和下架操作
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                ...
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    ...
                    <asp:Literal ID="Literal7" runat="server" Text="商品分类" />：
                    ...
                    &nbsp;&nbsp;<asp:Literal ID="Literal8" runat="server" Text="商品编号" />：
            ...
            <div class="newsicon">
                <ul>
                    <li id="liAdd" runat="server" style="background: url(/admin/images/icon8.gif) no-repeat 5px 3px;">
                        <a href="AddWeiXinGroupBuy.aspx">
                            <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Site, lblAdd%>" /></a>
                    </li>
                    <li id="liEdit" runat="server" style="background: url(/admin/images/about16.gif) no-repeat 5px 3px;display:none">
                        <asp:Button ID="btEdit" runat="server" Text="更新" CssClass="Edit" OnClick="btnEdit_Click" />

                    </li>
                    <li id="liEditUpdatetime" runat="server" style="background: url(/admin/images/about16.gif) no-repeat 5px 3px;">
                        <asp:Button ID="btnEditUpdatetime" runat="server"  Text="更新排序" CssClass="Edit" OnClick="btnEditUpdatetime_Click"/>
                    </li>
                </ul>
            </div>
        </div>
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="销售价格" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" SortExpression="Price">
                    <ItemTemplate>
                        <%#Eval("Price", "￥{0:N2}")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="是否是首页推荐" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                    <ItemTemplate>
                        <%# GetIsIndex(Eval("IsIndex"))%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="商品楼层" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80">
                    <ItemTemplate>
                        <%#Eval("FloorID")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ControlStyle-Width="50" HeaderText="操作" ItemStyle-HorizontalAlign="Center"
                    ItemStyle-Width="80">
                    <ItemTemplate>
                        <a href='WeiXinUpdateGroupBuy.aspx?id=<%# Eval("GroupBuyId")%>' class="iframe">编辑</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
