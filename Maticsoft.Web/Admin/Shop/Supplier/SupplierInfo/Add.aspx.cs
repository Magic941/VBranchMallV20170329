...
namespace Maticsoft.Web.Admin.Shop.Supplier.SupplierInfo
{
    ...
    {
        protected override int Act_PageLoad { get { return 536; } } //Shop_商家管理_添加页
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                model.Slogan = this.txtSlogan.Text;
                model.Discount = this.txtDiscount.Text;
                model.IsOnLine = Convert.ToBoolean(this.radlIsOnLine.SelectedValue);
                #endregion
