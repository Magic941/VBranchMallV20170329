<%@ Page Title="商家列表" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Supplier.SupplierInfo.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnBind="BindData" OnPageIndexChanging="GridViewEx1_PageIndexChanging" OnRowDataBound="GridViewEx1_RowDataBound" OnRowDeleting="GridViewEx1_RowDeleting" UnExportedColumnNames="Modify" Width="100%" PageSize="10" DataKeyNames="SupplierId" ShowExportExcel="False" ShowExportWord="False" ExcelFileName="FileName1" CellPadding="3" BorderWidth="1px" ShowCheckAll="False">
            <Columns>
...
<span id="lbtnModify"  runat="server" >  <a href="Modify.aspx?id=<%# Eval("SupplierId")%>">
                            ...
                            &nbsp; </span>
                            <a href="Show.aspx?id=<%# Eval("SupplierId")%>">
                        ...
                        ConfirmText="<%$Resources:Site,TooltipDelConfirm %>" runat="server" CausesValidation="False" CommandName="Delete" 
