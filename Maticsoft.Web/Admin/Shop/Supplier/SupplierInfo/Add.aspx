        ...
        <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr>
             ...
             <tr>
                ...
                <td height="25">
                    <asp:TextBox ID="txtSlogan" runat="server" Width="350px" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td_class">
                ...
                <td height="25">
                    <asp:TextBox ID="txtDiscount" runat="server" Width="350px" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td_class">
            ...
            <tr>
                ...
                <td height="25">
                    <asp:RadioButtonList ID="radlIsOnLine" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="True" Text="上线" Selected="True"></asp:ListItem>
                        <asp:ListItem Value="False" Text="未上线"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr style="display: none;">
