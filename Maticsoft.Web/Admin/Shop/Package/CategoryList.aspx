<%@ Page Title="包装类型管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="CategoryList.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Package.CategoryList" %>
            ...
            <div class="newsicon">
                <ul>
                    <li style="background: url(/images/icon8.gif) no-repeat 5px 3px" runat="server"  ID="AddLi" >
                        <asp:HyperLink ID="hlkadd" runat="server" NavigateUrl="Categoryadd.aspx" >添加</asp:HyperLink>
                     <b>|</b> </li>
