                         ...
                         <tr>
                            <td width="14%" rowspan="3" class="img">
                                <div class="borderImage">
                                  <img id="Img2" ref="<%# @Maticsoft.Web.Components.FileHelper.GeThumbImage(Eval("ProductThumbnailUrl").ToString(), "T150X150_") %>" /></div>
                            </td>
                    ...
                    <div class="youhuiproductlist addedproductslist">
                     ...
                     <table width="100%" border="0" cellspacing="0" class="conlisttd" skuid="<%# Eval("SKUId") %>">
                        <tr>
                            <td width="14%" rowspan="3" class="img">
                                <div class="borderImage">
                                  <img id="Img1" ref="<%# @Maticsoft.Web.Components.FileHelper.GeThumbImage(Eval("ProductThumbnailUrl").ToString(), "T150X150_") %>" /></div>
                            </td>
                            <td height="27" colspan="5" class="br_none"><span class="Name">
                                <a href='#' target="_blank"><%# Eval("ProductName") %></a>
                            </span></td>
