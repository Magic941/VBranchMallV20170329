...
<%@ Page Title="商品图片重新生成" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
   CodeBehind="ImageReGen.aspx.cs" Inherits="Maticsoft.Web.Admin.Shop.Products.ImageReGen" %>
            ...
            <tr style="display: none">
                ...
                <td height="25">
                   <%-- <asp:TextBox ID="txtCategoryText" runat="server" Width="315px"></asp:TextBox>
                    ...
                    <Maticsoft:CategoriesDropList ID="dropParentID" runat="server" IsNull="true" />        
                </td>
            </tr>
            <tr>
                <td style="width: 8px;">
