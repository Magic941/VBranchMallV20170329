...
var SelectAttributHTML = '<tr class="colorclass" style="display:none;"><td class="td_class"></td><td><table cellspacing="0" cellpadding="0" width="100%" id="color_{0}" class="table" style="display: none; margin-top: 10px;margin-bottom: 10px;"><thead><tr><th class="th">{1}</th><th  class="th">图片（无图片可不填）</th></tr></thead><tbody></tbody></table></td></tr>';
                    ...
                    if ($(resultData.DATA).length == 0) {
                        ...
                        $(resultData.DATA).each(function () {
                            ...
                            $(data.AttributeValues).each(function () {
                                ...
                                targetInput.attr('id', tarId);
                                targetInput.css('cursor', 'pointer');
                                target.find('#li_' + this.valueId).append(targetInput).append($(attributeLabelHTMLForSpec.format(tarId, this.valueId, cutstr(this.valueStr, 10), this.valueId, this.valueStr, this.valueId, this.valueStr)).css('cursor', 'pointer'));
                                target.find('#AttributeContent').append('</li>');
                            ...
                            if (data.UserDefinedPic) {
                                ...
                                var Colortarget = $(SelectAttributHTML.format(data.AttributeId, data.AttributeName));
...
var skusTableHeadThBase = '<th style="width:30%;"><em>*</em>商品编码</th><th style="width:90px;"><em>*</em>销售价</th><th style="width:90px">成本价</th><th style="width:90px">内部成本</th>';  ///////////////////////////////3-17修改部分
...
skusTableTdBase += '<td ><input value="{3}" id="CostPrice2" class="OnlyFloat" style="width:90px;text-align: right;" maxlength="9 type="text"/></td>';  ///////////////////////////////////////////////////////////////////////////3-17修改部分
...
function GeneralSKUItem(skuArray, htSkuData, attributeIds) {
    ...
    $(skuArray).each(function (index) {
        ...
        dataTR.append(skusTableTdBase.format(
                ...
                productSKU.CostPrice2 ? parseFloat(productSKU.CostPrice2).toFixed(2) : "0",  ////////////////////////////////////////3-17修改部分
...
function GetBaseSKU() {
    var txtProductSKU, txtSalePrice, txtCostPrice, txtCostPrice2, txtStock, txtAlertStock, txtWeight, chkUpselling; ///////////////////////////////////3-17修改部分
    ...
    if ($('[id$=txtCostPrice2]').val()) { ///////////////////////////////////3-17修改部分
    ...
    var res = {
        ...
        "CostPrice2": txtCostPrice2 ? txtCostPrice2 : "0", ///////////////////////////////////3-17修改部分
        "Stock": txtStock,
...
function GetSelectedSKU() {
    var txtProductSKU, txtSalePrice, txtCostPrice, txtCostPrice2, txtStock, txtAlertStock, txtWeight, chkUpselling, SKUInfos, SKUItems, SKUItemTR, SKUValueTD;
    SKUInfos = [];
    ...
    SKUItemTR.each(function () {
        ...
        SKUInfos.push({
            ...
            "CostPrice2": txtCostPrice2 ? parseFloat(txtCostPrice2) : "0", ///////////////////////////////3-17修改部分
