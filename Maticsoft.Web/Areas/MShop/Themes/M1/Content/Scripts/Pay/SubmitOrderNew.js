...
function SubmitOrder(sender, shippingAddressId, shippingTypeId, paymentModeId, conpon, supplierFreight) {
    ...
    var activetypeval = $('#activetype').val();
                    ...
                    switch (resultData.STATUS) {
                        ...
                        case "SUCCESS":
                            ...
                            $("#order-loading").html("<b></b>订单提提交成功, 请稍后..").animate({ opacity: 1.0 }, 1000).fadeOut("slow", function () {
                                ...
                                window.location = $Maticsoft.BasePath + 'Order/SubmitSuccess/' + resultData.DATA.OrderId;
                            });
                            break;
                        case "NOSTOCK":
                        ...
                        case "UNAUTHORIZED":
                           ...
                           break;
                        case "NOCOUPON":
                            $.alertEx('很抱歉.<br/><br/><br/>' + resultData.FAILED, function () {
                                $.navURL($Maticsoft.BasePath + 'ShoppingCart/CartInfo');
                            });
                           break;
                        case "NOCOUPON":
