...
(function (global) {
    var req, s, head, baseElement, dataMain, src,
        ...
        version = '2.1.1',
        commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)@ViewBag.BasePathg,
    ...
    function newContext(contextName) {
            ...
            if (name && name.charAt(0) === '.') {
                ...
                if (baseName) {
                    if (config.pkgs[baseName]) {
                        ...
                        /@ViewBag.BasePathodule. For instance, baseName of 'one/two/three', maps to
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                /@ViewBag.BasePathay have changed.
                ...
                if (!relMap) {
                    localRequire.undef = function (id) {
                        ...
                        if (mod) {
                            ...
                            /@ViewBag.BasePathodule will be attempted to be reloaded
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            if (node.attachEvent &&
                ...
                /@ViewBag.BasePathentioned above about not doing the 'script execute,
