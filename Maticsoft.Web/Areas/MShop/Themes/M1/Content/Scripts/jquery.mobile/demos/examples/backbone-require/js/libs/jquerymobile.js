...
$.extend( $.support, {
	...
	// https://developers.google.com/chrome@ViewBag.BasePathobile/docs/user-agent#chrome_for_ios_user-agent
...
(function( $, undefined ) {
	...
	$.event.special.navigate = self = {
		...
		$.mobile.path = path = {
			...
			//
			//     [0]: http://jblas:password@mycompany.com:8080@ViewBag.BasePathail/inbox?msg=1234&type=unread#msg-content
			//     [1]: http://jblas:password@mycompany.com:8080@ViewBag.BasePathail/inbox?msg=1234&type=unread
			//     [2]: http://jblas:password@mycompany.com:8080@ViewBag.BasePathail/inbox
			...
			//    [11]: mycompany.com
			//    [12]: 8080
			//    [13]: @ViewBag.BasePathail/inbox
			//    [14]: @ViewBag.BasePathail/
			//    [15]: inbox
...
function createVirtualEvent( event, eventType ) {
	...
	if ( t.search(@ViewBag.BasePathouse(down|up)|click/) > -1 && !event.which ) {
		event.which = 1;
	}
...
// Source       - http://github.com/cowboy/jquery-hashchange/raw@ViewBag.BasePathaster/jquery.ba-hashchange.js
// (Minified)   - http://github.com/cowboy/jquery-hashchange/raw@ViewBag.BasePathaster/jquery.ba-hashchange.min.js (0.8kb gzipped)
// 
// About: License
// 
...
$.widget( "mobile.collapsible", $.mobile.widget, {
	...
	_create: function() {
		...
		collapsibleHeading
			...
			/@ViewBag.BasePathodify markup & attributes
			...
			if ( val ) {
				...
				for ( var i = listItems.length - 1; i >= 0; i-- ) {
					...
					if ( item.is( "li:jqmData(role=list-divider)" ) ) {
						...
						/@ViewBag.BasePathark to be hidden
