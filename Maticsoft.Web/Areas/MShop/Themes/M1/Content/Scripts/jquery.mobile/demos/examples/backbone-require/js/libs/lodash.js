...
;(function(window, undefined) {
   ...
   * http:/@ViewBag.BasePathsdn.microsoft.com/en-us/library/121hztk3(v=vs.94).aspx
   */
  try {
   ...
   * http:/@ViewBag.BasePathathiasbynens.be/notes/ambiguous-ampersands (under "semi-related fun fact")
   */
  var htmlEscapes = {
    '&': '&amp;',
    '<': '&lt;',
