...
$(function () {
    ...
    var activeidval = $("#hidactiveid").val();
    var activetypeval = $("#hidactivetype").val();
    ...
    $("#btnAddToCart").click(function () {
        ...
        //    //立刻购买
        //    location.href = $Maticsoft.BasePath + "Order/SubmitOrder?sku=" + $(this).attr('itemid') + "&Count=" + count+"&activeid="+activeidval+"&activetype="+activetypeval;
        //} else {
        ////加入购物车
        location.href = $Maticsoft.BasePath + "ShoppingCart/AddCart?sku=" + $(this).attr('itemid') + "&Count=" + count + "&activeid=" + activeidval + "&activetype=" + activetypeval;
        //}
    });
    $("#btnQukBuy").click(function ()
    {
        if ($(this).hasClass('addCart-gray')) return false;
        if (!$(this).attr('itemid')) {
            $('#SKUOptions,#SKUOptions a').effect('highlight', 500);
