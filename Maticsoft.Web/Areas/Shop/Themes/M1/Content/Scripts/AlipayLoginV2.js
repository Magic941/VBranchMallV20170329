...
$(function() {
    $(".i-alipay").click(function() {
        var strLoginType = $.trim($(this).attr("logintype"));
        var strReturnUrl = ""

        switch (strLoginType) {
            case "default": //login.maticsoft域登录
            ...
            break;*/ 
            case "other": //不是login.maticsoft域且不为浮存登录
        ...
        window.open("http://login.maticsoft.com/Alipay/alipayTransferRequest.aspx?logintype=" + strLoginType + "&returnurl=" + strReturnUrl);
    });
});