...
//        var currentTable = currentTableTR.find('table');
    ...
    $('#btnClear').bind('click', function() {
        $.ajax({
            url: $Maticsoft.BasePath + "UserCenter/ClearProductsStatMode",
            type: 'POST',
            dataType: 'text',
            timeout: 10000,
            data: { SelectType: 0 },
     ...
     $('#hidproductclass').val($.getUrlParam('categoryId'));
...
function insertProductStationMode(productId, type) {
    $.ajax({
        url: $Maticsoft.BasePath + "UserCenter/AddProductStationMode",
...
function RemoveProductStationMode(productId, type) {
    $.ajax({
        url: $Maticsoft.BasePath + "UserCenter/RemoveProductStationMode",
        type: 'POST', dataType: 'json', timeout: 10000,
        data: { ProductId: productId, Type: type },
        async: false,
        success: function (resultData) {
