(function () {
    ...
    $(function () {
        ...
        $('#SKUOptions .SkuItems').each(function () {
            ...
            ////            }
            //if (imgurl) {
            //    $('#J_zoom img').attr('jqimg', imgurl).attr('ref', imgurl).removeAttr('src').removeAttr('loaded');
            //    $.scaleLoad('#J_zoom', 400, 400);
            //}

            var selectedObjs = $('#SKUOptions .cur');
            //alert(selectedObjs.length);
