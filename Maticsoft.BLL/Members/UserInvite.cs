...
namespace Maticsoft.BLL.Members
{
	...
	public partial class UserInvite
	{
		...
		public Maticsoft.Model.Members.UserInvite GetModelByCache(int InviteId)
		{
			...
			return (Maticsoft.Model.Members.UserInvite)objModel;
		}
		...
		{
			List<Maticsoft.Model.Members.UserInvite> modelList = new List<Maticsoft.Model.Members.UserInvite>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Members.UserInvite model;
