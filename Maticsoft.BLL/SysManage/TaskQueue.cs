...
namespace Maticsoft.BLL.SysManage
{
	...
	public partial class TaskQueue
	{
		...
		public Maticsoft.Model.SysManage.TaskQueue GetModelByCache(int ID,int Type)
		{
			...
			return (Maticsoft.Model.SysManage.TaskQueue)objModel;
		}
		...
		{
			List<Maticsoft.Model.SysManage.TaskQueue> modelList = new List<Maticsoft.Model.SysManage.TaskQueue>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SysManage.TaskQueue model;
