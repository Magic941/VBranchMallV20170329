...
namespace Maticsoft.BLL.Shop.Supplier
{
	...
	public partial class SupplierMenus
	{
		...
		public Maticsoft.Model.Shop.Supplier.SupplierMenus GetModelByCache(int MenuId)
		{
			...
			return (Maticsoft.Model.Shop.Supplier.SupplierMenus)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Supplier.SupplierMenus> modelList = new List<Maticsoft.Model.Shop.Supplier.SupplierMenus>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Supplier.SupplierMenus model;
       ...
       /// <returns></returns>
        public List<Maticsoft.Model.Shop.Supplier.SupplierMenus> GetModelList(int top,int suppId)
        {
            DataSet ds = dal.GetList(top, string.Format(" SupplierId={0} and IsUsed=1 ", suppId), " Sequence ");
            return DataTableToList(ds.Tables[0]);
        }
        public List<Maticsoft.Model.Shop.Supplier.SupplierMenus> GetListByPageEx(string strWhere, string orderby, int startIndex, int endIndex)
        {
