...
namespace Maticsoft.BLL.Shop.Supplier
{
	...
	public partial class SupplierScoreDetails
	{
		...
		public Maticsoft.Model.Shop.Supplier.SupplierScoreDetails GetModelByCache(int ID)
		{
			...
			return (Maticsoft.Model.Shop.Supplier.SupplierScoreDetails)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Supplier.SupplierScoreDetails> modelList = new List<Maticsoft.Model.Shop.Supplier.SupplierScoreDetails>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Supplier.SupplierScoreDetails model;
