...
namespace Maticsoft.BLL.Shop.Supplier
{
	...
	public partial class SupplierRankThemes
	{
		...
		public Maticsoft.Model.Shop.Supplier.SupplierRankThemes GetModelByCache(int RankId,int ThemeId)
		{
			...
			return (Maticsoft.Model.Shop.Supplier.SupplierRankThemes)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Supplier.SupplierRankThemes> modelList = new List<Maticsoft.Model.Shop.Supplier.SupplierRankThemes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Supplier.SupplierRankThemes model;
