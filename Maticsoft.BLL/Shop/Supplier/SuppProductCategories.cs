...
namespace Maticsoft.BLL.Shop.Supplier
{
	...
	public partial class SuppProductCategories
	{
		...
		public Maticsoft.Model.Shop.Supplier.SuppProductCategories GetModelByCache(int CategoryId,long ProductId)
		{
			...
			return (Maticsoft.Model.Shop.Supplier.SuppProductCategories)objModel;
		}
		/// <summary>
		/// 获得数据列表
		/// </summary>
		...
		{
			List<Maticsoft.Model.Shop.Supplier.SuppProductCategories> modelList = new List<Maticsoft.Model.Shop.Supplier.SuppProductCategories>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Supplier.SuppProductCategories model;
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Maticsoft.Model.Shop.Supplier.SuppProductCategories GetModelByCache(long ProductId)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.Shop.Supplier.SuppProductCategories GetModel(long ProductId)
        {
