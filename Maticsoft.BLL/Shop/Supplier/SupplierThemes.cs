...
namespace Maticsoft.BLL.Shop.Supplier
{
	...
	public partial class SupplierThemes
	{
		...
		public Maticsoft.Model.Shop.Supplier.SupplierThemes GetModelByCache(int ThemeId)
		{
			...
			return (Maticsoft.Model.Shop.Supplier.SupplierThemes)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Supplier.SupplierThemes> modelList = new List<Maticsoft.Model.Shop.Supplier.SupplierThemes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Supplier.SupplierThemes model;
