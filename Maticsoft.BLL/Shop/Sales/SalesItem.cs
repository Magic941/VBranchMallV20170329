...
namespace Maticsoft.BLL.Shop.Sales
{
	...
	public partial class SalesItem
	{
		...
		public Maticsoft.Model.Shop.Sales.SalesItem GetModelByCache(int ItemId)
		{
			...
			return (Maticsoft.Model.Shop.Sales.SalesItem)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Sales.SalesItem> modelList = new List<Maticsoft.Model.Shop.Sales.SalesItem>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Sales.SalesItem model;
