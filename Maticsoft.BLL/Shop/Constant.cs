...
namespace Maticsoft.BLL.Shop
{
	...
	public partial class Constant
	{
		...
		public Maticsoft.Model.Shop.Constant GetModelByCache()
		{
			...
			return (Maticsoft.Model.Shop.Constant)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Constant> modelList = new List<Maticsoft.Model.Shop.Constant>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Constant model;
