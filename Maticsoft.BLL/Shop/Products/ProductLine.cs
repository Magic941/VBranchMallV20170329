...
namespace Maticsoft.BLL.Shop.Products
{
	...
	public partial class ProductLine
	{
		...
		public Maticsoft.Model.Shop.Products.ProductLine GetModelByCache(int LineId)
		{
			...
			return (Maticsoft.Model.Shop.Products.ProductLine)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Products.ProductLine> modelList = new List<Maticsoft.Model.Shop.Products.ProductLine>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Products.ProductLine model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.Shop.Products.ProductLine();
