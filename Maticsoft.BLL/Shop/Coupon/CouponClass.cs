...
namespace Maticsoft.BLL.Shop.Coupon
{
	...
	public partial class CouponClass
	{
		...
		public Maticsoft.Model.Shop.Coupon.CouponClass GetModelByCache(int ClassId)
		{
			...
			return (Maticsoft.Model.Shop.Coupon.CouponClass)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Coupon.CouponClass> modelList = new List<Maticsoft.Model.Shop.Coupon.CouponClass>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Coupon.CouponClass model;
