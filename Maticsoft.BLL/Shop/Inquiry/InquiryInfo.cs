...
namespace Maticsoft.BLL.Shop.Inquiry
{
	...
	public partial class InquiryInfo
	{
		...
		public Maticsoft.Model.Shop.Inquiry.InquiryInfo GetModelByCache(long InquiryId)
		{
			...
			return (Maticsoft.Model.Shop.Inquiry.InquiryInfo)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Inquiry.InquiryInfo> modelList = new List<Maticsoft.Model.Shop.Inquiry.InquiryInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Inquiry.InquiryInfo model;
