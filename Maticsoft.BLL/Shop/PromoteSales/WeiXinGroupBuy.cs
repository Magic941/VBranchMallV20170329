...
namespace Maticsoft.BLL.Shop.PromoteSales
{
    ...
    {
        private readonly IWeiXinGroupBuy dal = DAShopProSales.CreateShop_WeiXinGroupBuy();
        ...
        public bool Update(Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy model)
        {
            if (Maticsoft.BLL.DataCacheType.CacheType == 1)
            {
                ...
                if (RedisBase.Item_Get<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>(CacheKey) != null)
                {

                    RedisBase.Item_Set<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>(CacheKey, model);
                }
            }
        ...
        {
            Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy groupBuy = null;
            if (Maticsoft.BLL.DataCacheType.CacheType == 1)
            {
                string CacheKey = "ProductImagesModel-" + GroupBuyId.ToString();
                groupBuy = RedisBase.Item_Get<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>(CacheKey);
            }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy GetModelByCache(int GroupBuyId)
        {
            ...
            if (Maticsoft.BLL.DataCacheType.CacheType == 1)
            {
                Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy groupBuy = new Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy();
                groupBuy = RedisBase.Item_Get<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>(CacheKey);
                objModel = groupBuy;
            }
            ...
            if (objModel == null)
            {
                try
                {
                    ...
                    if (objModel != null)
                    {
                        ...
                        if (Maticsoft.BLL.DataCacheType.CacheType == 1)
                        {
                            RedisBase.Item_Set<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>(CacheKey, (Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy)objModel);
                        }
                        if (Maticsoft.BLL.DataCacheType.CacheType == 0)
                        {
            ...
            return (Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy)objModel;
        }
        ...
        /// <returns></returns>
        public Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy GetModelByGroupID(int groupBuyID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy> DataTableToList(DataTable dt)
        {
            List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy> modelList = new List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy model;
        ...
        //public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory> DataTable2List(DataTable dt)
        //{
        //    List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory> modelList = new List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory>();
        //     int rowsCount = dt.Rows.Count;
        //    if (rowsCount > 0)
        //    {
        //        Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory model;
        //        for (int n = 0; n < rowsCount; n++)
        //        {
        ...
        {
            Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy model = GetModelByCache(buyId);
            if (model == null)
                return false;
        ...
        public List<Model.Shop.PromoteSales.WeiXinGroupBuy> GetListByPage(string strWhere, int cid, int regionId, string orderby, int startIndex, int endIndex, int promotionType)
        {
            switch (orderby)
            {
                case "default":
        ...
        public List<Model.Shop.PromoteSales.WeiXinGroupBuy> GetCategory(string strWhere)
        {
        ...
        public List<Model.Shop.PromoteSales.WeiXinGroupBuy> GetGroupBuyLimt4Hour()
        {
            DataSet ds = dal.GetGroupBuyLimt4Hour();
            return DataTableToList(ds.Tables[0]);
        }

        //public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory> GetGroupbuyHistory(int groupbuyid)
        //{
        ...
        //public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuyHistory> GetGroubuyHistoryByPage(int groupbuyid, int startindex, int endindex)
        //{
        ...
        {
            return dal.GetFloor_IsDisplay(FloorID, Sequence, IsIndex, status, ProductId);
        }
        public bool Update_status(int FloorID, int Sequence, int IsIndex, int status)
        {
            return dal.Update_status(FloorID, Sequence, IsIndex, status);
        }

        //精品商城
        public List<Maticsoft.Model.Shop.PromoteSales.WeiXinGroupBuy> GetBoutiqueMall(string strWhere)
        {

            DataSet ds = dal.GetBoutiqueMall(string.Format(strWhere));
