...
namespace Maticsoft.BLL.Shop.Order
{
	...
	public partial class OrderOptions
	{
        ...
        public Maticsoft.Model.Shop.Order.OrderOptions GetModelByCache(int LookupListId, int LookupItemId, long OrderId)
        {
            ...
            return (Maticsoft.Model.Shop.Order.OrderOptions)objModel;
        }
        ...
        {
            List<Maticsoft.Model.Shop.Order.OrderOptions> modelList = new List<Maticsoft.Model.Shop.Order.OrderOptions>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.Shop.Order.OrderOptions model;
