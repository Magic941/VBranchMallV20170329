...
namespace Maticsoft.BLL.Shop.Order
{
	...
	public partial class OrdersHistory
	{
		...
		public Maticsoft.Model.Shop.Order.OrdersHistory GetModelByCache(long OrderId)
		{
			...
			return (Maticsoft.Model.Shop.Order.OrdersHistory)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Order.OrdersHistory> modelList = new List<Maticsoft.Model.Shop.Order.OrdersHistory>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Order.OrdersHistory model;
