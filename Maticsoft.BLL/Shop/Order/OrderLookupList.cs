...
namespace Maticsoft.BLL.Shop.Order
{
	...
	public partial class OrderLookupList
	{
        ...
        public Maticsoft.Model.Shop.Order.OrderLookupList GetModelByCache(int LookupListId)
        {
            ...
            return (Maticsoft.Model.Shop.Order.OrderLookupList)objModel;
        }
        ...
        {
            List<Maticsoft.Model.Shop.Order.OrderLookupList> modelList = new List<Maticsoft.Model.Shop.Order.OrderLookupList>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.Shop.Order.OrderLookupList model;
