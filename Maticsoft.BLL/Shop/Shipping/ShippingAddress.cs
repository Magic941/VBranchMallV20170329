...
namespace Maticsoft.BLL.Shop.Shipping
{
    ...
    public partial class ShippingAddress
    {
        ...
        public Maticsoft.Model.Shop.Shipping.ShippingAddress GetModelByCache(int ShippingId)
        {
            ...
            return (Maticsoft.Model.Shop.Shipping.ShippingAddress)objModel;
        }
        ...
        public Maticsoft.Model.Shop.Shipping.ShippingAddress GetModel(int ShippingId)
        {
            ...
            Maticsoft.Model.Shop.Shipping.ShippingAddress model = dal.GetModel(ShippingId);
            if (model != null)
            {
                //加载区域完整名
        ...
        {
            BLL.Ms.Regions regionsManage = new Ms.Regions();
            List<Maticsoft.Model.Shop.Shipping.ShippingAddress> modelList = new List<Maticsoft.Model.Shop.Shipping.ShippingAddress>();
