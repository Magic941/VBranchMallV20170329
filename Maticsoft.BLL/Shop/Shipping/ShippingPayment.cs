...
namespace Maticsoft.BLL.Shop.Shipping
{
	...
	public partial class ShippingPayment
	{
		...
		public Maticsoft.Model.Shop.Shipping.ShippingPayment GetModelByCache(int ShippingModeId,int PaymentModeId)
		{
			...
			return (Maticsoft.Model.Shop.Shipping.ShippingPayment)objModel;
		}
		...
		{
			List<Maticsoft.Model.Shop.Shipping.ShippingPayment> modelList = new List<Maticsoft.Model.Shop.Shipping.ShippingPayment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Shop.Shipping.ShippingPayment model;
