...
namespace Maticsoft.BLL.CMS
{
	...
	public partial class Comment
	{
		...
		public Maticsoft.Model.CMS.Comment GetModelByCache(int ID)
		{
			...
			return (Maticsoft.Model.CMS.Comment)objModel;
		}
		...
		public List<Maticsoft.Model.CMS.Comment> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				Maticsoft.Model.CMS.Comment model;
        ...
        ///// 获得数据列表
        ///// </summary>
        //public List<Maticsoft.Model.CMS.Comment> GetCommentsByPage(int cid, int typeid, int StartIndex, int EndIndex, out int toalCount)
        //{
        //    StringBuilder strBuider = new StringBuilder();
