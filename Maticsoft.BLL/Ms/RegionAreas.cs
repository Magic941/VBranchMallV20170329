...
namespace Maticsoft.BLL.Ms
{
	...
	public partial class RegionAreas
	{
		...
		public Maticsoft.Model.Ms.RegionAreas GetModelByCache(int AreaId)
		{
			...
			return (Maticsoft.Model.Ms.RegionAreas)objModel;
		}
		...
		{
			List<Maticsoft.Model.Ms.RegionAreas> modelList = new List<Maticsoft.Model.Ms.RegionAreas>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Ms.RegionAreas model;
