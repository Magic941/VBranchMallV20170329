...
namespace Maticsoft.BLL.Ms
{
	...
	public partial class WeiBoMsg
	{
        ...
        public Maticsoft.Model.Ms.WeiBoMsg GetModelByCache(int WeiBoId)
        {
            ...
            return (Maticsoft.Model.Ms.WeiBoMsg)objModel;
        }
        ...
        {
            List<Maticsoft.Model.Ms.WeiBoMsg> modelList = new List<Maticsoft.Model.Ms.WeiBoMsg>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Maticsoft.Model.Ms.WeiBoMsg model;
