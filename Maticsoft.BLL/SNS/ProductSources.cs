...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class ProductSources
	{
		...
		public Maticsoft.Model.SNS.ProductSources GetModelByCache(int ID)
		{
			...
			return (Maticsoft.Model.SNS.ProductSources)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.ProductSources> modelList = new List<Maticsoft.Model.SNS.ProductSources>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.ProductSources model;
        ...
        public  int GetIdByWebSiteName(string WebSiteName)
        {
          ...
          List<Maticsoft.Model.SNS.ProductSources> list=GetModelList("WebSiteName='" + WebSiteName + "'");
          if (list.Count > 0)
          {
              return list[0].ID;
