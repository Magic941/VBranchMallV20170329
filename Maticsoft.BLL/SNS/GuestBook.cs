...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class GuestBook
	{
		...
		public Maticsoft.Model.SNS.GuestBook GetModelByCache(int GuestBookID)
		{
			...
			return (Maticsoft.Model.SNS.GuestBook)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.GuestBook> modelList = new List<Maticsoft.Model.SNS.GuestBook>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.GuestBook model;
