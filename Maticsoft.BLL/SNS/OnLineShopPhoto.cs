...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class OnLineShopPhoto
	{
		...
		public Maticsoft.Model.SNS.OnLineShopPhoto GetModelByCache(int PhotoID,int ProductID)
		{
			...
			return (Maticsoft.Model.SNS.OnLineShopPhoto)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.OnLineShopPhoto> modelList = new List<Maticsoft.Model.SNS.OnLineShopPhoto>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.OnLineShopPhoto model;
