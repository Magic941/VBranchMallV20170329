...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class SearchWordLog
	{
		...
		public Maticsoft.Model.SNS.SearchWordLog GetModelByCache(int ID)
		{
			...
			return (Maticsoft.Model.SNS.SearchWordLog)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.SearchWordLog> modelList = new List<Maticsoft.Model.SNS.SearchWordLog>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.SearchWordLog model;
        ...
        {
            return dal.GetList(0, string.Format(" SearchWord like '%{0}%' ",Keywords), "");
        }
          /// <summary>
        /// 获得前几行数据
        /// </summary>
