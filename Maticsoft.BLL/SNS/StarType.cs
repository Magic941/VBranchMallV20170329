...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class StarType
	{
		...
		public Maticsoft.Model.SNS.StarType GetModelByCache(int TypeID)
		{
			...
			return (Maticsoft.Model.SNS.StarType)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.StarType> modelList = new List<Maticsoft.Model.SNS.StarType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.StarType model;
