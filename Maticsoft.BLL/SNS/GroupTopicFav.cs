...
namespace Maticsoft.BLL.SNS
{
	...
	public partial class GroupTopicFav
	{
		...
		public Maticsoft.Model.SNS.GroupTopicFav GetModelByCache(int ID)
		{
			...
			return (Maticsoft.Model.SNS.GroupTopicFav)objModel;
		}
		...
		{
			List<Maticsoft.Model.SNS.GroupTopicFav> modelList = new List<Maticsoft.Model.SNS.GroupTopicFav>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.SNS.GroupTopicFav model;
