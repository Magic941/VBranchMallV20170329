...
namespace Maticsoft.SQLServerDAL.SysManage
{
    ...
    public partial class ConfigArea : IConfigArea
	{
		...
		public Maticsoft.Model.SysManage.ConfigArea GetModel(string AreaName)
		{
			...
			Maticsoft.Model.SysManage.ConfigArea model=new Maticsoft.Model.SysManage.ConfigArea();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.SysManage.ConfigArea DataRowToModel(DataRow row)
		{
			Maticsoft.Model.SysManage.ConfigArea model=new Maticsoft.Model.SysManage.ConfigArea();
			if (row != null)
			{
