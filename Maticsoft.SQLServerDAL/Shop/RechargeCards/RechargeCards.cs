...
namespace Maticsoft.SQLServerDAL.Shop
{
	...
	public partial class RechargeCards:IRechargeCards
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Shop_RechargeCards"); 
		}
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Shop.RechargeCards DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Shop.RechargeCards model=new Maticsoft.Model.Shop.RechargeCards();
			if (row != null)
			{
        ...
        public Maticsoft.Model.Shop.RechargeCards ExitEx(string number)
        {
            StringBuilder strSql = new StringBuilder();
