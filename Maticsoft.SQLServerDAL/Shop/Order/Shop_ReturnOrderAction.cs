...
{
	/// <summary>
	/// 数据访问类:Shop_ReturnOrderAction
	/// </summary>
	public partial class Shop_ReturnOrderAction:IShop_ReturnOrderAction
	{
		...
		public Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction GetModel(long ActionId)
		{
			...
			Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction model=new Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction model=new Maticsoft.Model.Shop.Order.Shop_ReturnOrderAction();
			if (row != null)
			{
