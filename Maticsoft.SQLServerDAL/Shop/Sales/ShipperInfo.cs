...
namespace Maticsoft.SQLServerDAL.Shop.Sales
{
	...
	public partial class ShipperInfo:IShipperInfo
	{
		...
		public Maticsoft.Model.Shop.Sales.ShipperInfo GetModel(int ShipperId)
		{
			...
			Maticsoft.Model.Shop.Sales.ShipperInfo model=new Maticsoft.Model.Shop.Sales.ShipperInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Shop.Sales.ShipperInfo DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Shop.Sales.ShipperInfo model=new Maticsoft.Model.Shop.Sales.ShipperInfo();
			if (row != null)
			{
