...
namespace Maticsoft.SQLServerDAL.Shop.PromoteSales
{
	...
	public partial class CountDown:ICountDown
	{
		...
		public int Add(Maticsoft.Model.Shop.PromoteSales.CountDown model)
		{
			...
			strSql.Append("ProductId,EndDate,Description,Sequence,Price,Status)");
		...
		public Maticsoft.Model.Shop.PromoteSales.CountDown GetModel(int CountDownId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CountDownId,ProductId,EndDate,Description,Sequence,Price,Status from Shop_CountDown ");
			strSql.Append(" where CountDownId=@CountDownId");
			SqlParameter[] parameters = {
					new SqlParameter("@CountDownId", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CountDownId,ProductId,EndDate,Description,Sequence,Price,Status ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" CountDownId,ProductId,EndDate,Description,Sequence,Price,Status ");
			strSql.Append(" FROM Shop_CountDown ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
