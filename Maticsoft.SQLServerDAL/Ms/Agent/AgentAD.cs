...
namespace Maticsoft.SQLServerDAL.Ms.Agent
{
	...
	public partial class AgentAD:IAgentAD
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AdvertisementId", "Ms_AgentAD"); 
		}
		...
		public Maticsoft.Model.Ms.Agent.AgentAD GetModel(int AdvertisementId)
		{
			...
			Maticsoft.Model.Ms.Agent.AgentAD model=new Maticsoft.Model.Ms.Agent.AgentAD();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Ms.Agent.AgentAD DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Ms.Agent.AgentAD model=new Maticsoft.Model.Ms.Agent.AgentAD();
			if (row != null)
			{
