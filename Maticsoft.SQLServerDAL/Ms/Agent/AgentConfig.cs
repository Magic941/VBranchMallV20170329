...
namespace Maticsoft.SQLServerDAL.Ms.Agent
{
	...
	public partial class AgentConfig:IAgentConfig
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Ms_AgentConfig"); 
		}
		...
		public Maticsoft.Model.Ms.Agent.AgentConfig GetModel(int ID)
		{
			...
			Maticsoft.Model.Ms.Agent.AgentConfig model=new Maticsoft.Model.Ms.Agent.AgentConfig();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Ms.Agent.AgentConfig DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Ms.Agent.AgentConfig model=new Maticsoft.Model.Ms.Agent.AgentConfig();
			if (row != null)
			{
