...
namespace Maticsoft.WeChat.BLL.Core
{
	...
	{
        private readonly ILocation dal = Maticsoft.DBUtility.PubConstant.IsSQLServer ? (ILocation)new Maticsoft.WeChat.SQLServerDAL.Core.Location() : null;//暂时预留
		public Location()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.WeChat.Model.Core.Location GetModelByCache(long LocationId)
		{
			...
			return (Maticsoft.WeChat.Model.Core.Location)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.WeChat.Model.Core.Location> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.WeChat.Model.Core.Location> DataTableToList(DataTable dt)
		{
			List<Maticsoft.WeChat.Model.Core.Location> modelList = new List<Maticsoft.WeChat.Model.Core.Location>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.WeChat.Model.Core.Location model;
