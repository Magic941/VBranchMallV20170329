...
namespace Maticsoft.WeChat.SQLServerDAL.Core
{
	...
	public partial class Config:IConfig
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "WeChat_Config"); 
		}
		...
		public Maticsoft.WeChat.Model.Core.Config GetModel(int ID)
		{
			...
			Maticsoft.WeChat.Model.Core.Config model=new Maticsoft.WeChat.Model.Core.Config();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.WeChat.Model.Core.Config DataRowToModel(DataRow row)
		{
			Maticsoft.WeChat.Model.Core.Config model=new Maticsoft.WeChat.Model.Core.Config();
			if (row != null)
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WeChat_Config";
