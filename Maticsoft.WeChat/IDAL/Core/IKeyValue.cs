...
namespace Maticsoft.WeChat.IDAL.Core
{
	...
	public interface IKeyValue
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.WeChat.Model.Core.KeyValue model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.WeChat.Model.Core.KeyValue model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Maticsoft.WeChat.Model.Core.KeyValue GetModel(int ValueId);
		Maticsoft.WeChat.Model.Core.KeyValue DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
